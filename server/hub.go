...
import (
	...
	"github.com/jakubbartel/colladraw/server/message"
...
func (hub *Hub) onConnect(client *Client) {
	log.Printf("client connected: %s", client.socket.RemoteAddr())
...
func (hub *Hub) onDisconnect(client *Client) {
	log.Printf("client disconnected: %s", client.socket.RemoteAddr())
	client.close()
